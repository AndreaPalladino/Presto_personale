...
@section('content')
    <div class="container my-5 py-5">
        <div class="row">
            <div class="col-12">
            <form action="{{route('update', compact('announcement'))}}" method="POST">
                @method('PUT')
                    @csrf
                    <div class="form-group">
                      <label for="exampleFormControlInput1" class="text30 mt-3">Title</label>
                      <input name="title" type="text" class="form-control border-custom bg-transparent" id="exampleFormControlInput1" value="{{$announcement->title}} ">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="description" class="form-control textBorder bg-transparent" id="exampleFormControlTextarea1" rows="3">{{$announcement->description}}</textarea>
                    </div>
                    <button type="submit" class="btn btncustom mx-auto d-block mt-5">Update</button>
                  </form>
            </div>
        </div>
    </div>
